...
const kase = (over: Partial<DeliberationCase> = {}): DeliberationCase => ({
  ...
  closedEarly: null,
  adjudication: ADJ,
  // Required since the consensus over the three adjudication runs became part of the
  // case rather than of the response that produced it. Null is a real state: a case
  // adjudicated before that existed has a verdict and no record of how settled it was.
  consensus: null,
