...
TARGETS = {
    ...
    "packages/engine/src/plan.ts": "export function planNextExperiment(",
    "packages/engine/test/plan.test.ts": 'describe("pivotalRules"',
    "data/assays.json": "statedLimitations",
